                ...
                <section class="sidebar">
                    ...
                    <li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{ route('product_unit.index') }}"><i class="fa fa-circle-o"></i> Unit
                                        View</a></li>
                                <li><a href="{{ route('product_unit.create') }}"><i class="fa fa-circle-o"></i> Unit
                                        Add</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{ route('supplier.index') }}"><i class="fa fa-circle-o"></i> Supplier
                                        View</a></li>
                                <li><a href="{{ route('supplier.create') }}"><i class="fa fa-circle-o"></i> Supplier
                                        Add</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{ route('product.index') }}"><i class="fa fa-circle-o"></i> Supplier
                                        View</a></li>
                                <li><a href="{{ route('product.create') }}"><i class="fa fa-circle-o"></i> Supplier
                                        Add</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="{{ route('order.index') }}"><i class="fa fa-circle-o"></i> Order view</a></li>
                                <li><a href="{{ route('order.create') }}"><i class="fa fa-circle-o"></i> Purchase Order</a></li>
                            </ul>
                        </li>
                        <li>
